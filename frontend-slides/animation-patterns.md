...
| Vietnamese diacritics clipped | Increase `line-height` to 1.6+; add `padding-top: 0.1em` on headings |
| Vietnamese text too dense | Reduce content density by 15%; split long bullets into multiple slides |
