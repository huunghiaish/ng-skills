...
```html
<!DOCTYPE html>
<html lang="en"> <!-- Use lang="vi" for Vietnamese content -->
<head>
    <meta charset="UTF-8">
    ...
    <!-- For Vietnamese: use fonts from references/vietnamese-typography.md -->
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ===========================================
           VIETNAMESE TYPOGRAPHY (include if lang="vi")
           =========================================== */
        /* body {
            line-height: 1.6;
            word-break: keep-all;
...
**If the user chose "No"/"Khong" for inline editing in Phase 1, do NOT generate any edit-related HTML, CSS, or JS.**
...
<button class="edit-toggle" id="editToggle" title="Che do chinh sua (E)">&#9998;</button>
<!-- Vietnamese: title="Che do chinh sua (E)" -->
<!-- English: title="Edit mode (E)" -->
```
...
- `lang` attribute set correctly (`vi` or `en`)
