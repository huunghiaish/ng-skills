...
**Vietnamese Content:** Each preset lists a Vietnamese-compatible font alternative. When generating Vietnamese slides, use the "Vi Font" instead of the default Display/Body font if the default does NOT support Vietnamese diacritics. See [references/vietnamese-typography.md](references/vietnamese-typography.md) for the full Vietnamese font guide.
...
- **Vi Font:** Display `Be Vietnam Pro` (800/900), Body `Be Vietnam Pro` (400/500)
...
- **Vi Font:** `Manrope` supports Vietnamese natively (Google Fonts Vietnamese subset)
...
- **Vi Font:** Display `Lexend` (700/800), Mono `JetBrains Mono` (400/700)
...
- **Vi Font:** Display `Playfair Display` (400/600), Body `Be Vietnam Pro` (300/400)
...
- **Vi Font:** Display `Lora` (400/700), Body `Be Vietnam Pro` (400/500)
...
- **Vi Font:** `Plus Jakarta Sans` supports Vietnamese natively
...
- Body: `Outfit` (400/500)
- **Vi Font:** `Outfit` supports Vietnamese natively
...
- **Vi Font:** Display `Lora` (700), Body `Nunito` (400/500)
...
**Vi Font:** `Lexend` (700) + `Be Vietnam Pro` (400)
...
**Vi Font:** `JetBrains Mono` supports Vietnamese natively
...
**Vi Font:** `Archivo` supports Vietnamese, `Nunito` supports Vietnamese natively
...
| Preset | Display Font | Body Font | Vi Display | Vi Body | Source |
|--------|--------------|-----------|------------|---------|--------|
| Bold Signal | Archivo Black | Space Grotesk | Be Vietnam Pro (800) | Be Vietnam Pro (400) | Google |
| Electric Studio | Manrope | Manrope | Manrope | Manrope | Google |
| Creative Voltage | Syne | Space Mono | Lexend | JetBrains Mono | Google |
| Dark Botanical | Cormorant | IBM Plex Sans | Playfair Display | Be Vietnam Pro | Google |
| Notebook Tabs | Bodoni Moda | DM Sans | Lora | Be Vietnam Pro | Google |
| Pastel Geometry | Plus Jakarta Sans | Plus Jakarta Sans | Plus Jakarta Sans | Plus Jakarta Sans | Google |
| Split Pastel | Outfit | Outfit | Outfit | Outfit | Google |
| Vintage Editorial | Fraunces | Work Sans | Lora | Nunito | Google |
| Neon Cyber | Clash Display | Satoshi | Lexend | Be Vietnam Pro | Mixed |
| Terminal Green | JetBrains Mono | JetBrains Mono | JetBrains Mono | JetBrains Mono | JetBrains |
| Swiss Modern | Archivo | Nunito | Archivo | Nunito | Google |
| Paper & Ink | Cormorant Garamond | Source Serif 4 | Lora | Merriweather | Google |
